...
import { DailyProfitAndSubOrders } from '@/types';
import { IconCalendar, IconInfinity } from '@tabler/icons-react';

interface DailyProfitAndSubOrdersProps {
  data: DailyProfitAndSubOrders[];
}
...
export function DailyProfitAndSubOrdersChart({ data }: DailyProfitAndSubOrdersProps) {
      ...
      <CardHeader className="p-3">
        <CardTitle>
          <div className="flex flex-col justify-start gap-1">
            ...
            {tStats('daily-profit-sub-orders-title')}
          </div>
        </CardTitle>
        <CardDescription>{tStats('daily-profit-sub-orders-description')}</CardDescription>
      </CardHeader>
