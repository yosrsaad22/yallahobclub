...
interface ProductComboboxProps {
  products: (Product & { supplierCode: string; media: MediaType[] })[];
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <p className="text-muted-foreground">
                              ...
                              <span className="text-foreground"> {product.supplierCode}</span>
                            </p>
                          </div>
                        </div>
                        <div className="flex flex-row items-center justify-center gap-4">
                          <div className="flex flex-col items-center justify-center gap-1 px-2">
                            <span className="text-sm text-muted-foreground">{tFields('product-stock')}</span>
                            <span className="font-semibold">{product.stock}</span>
                          </div>
                          <div className="flex flex-col items-center justify-center gap-1">
                            <span className="text-sm text-muted-foreground">{tFields('product-wholesale-price')}</span>
                            <span className="font-semibold">{product.wholesalePrice} TND</span>
                          </div>

                          <div className="flex flex-col items-center justify-center gap-1">
                            <span className="text-sm text-muted-foreground">{tFields('product-profit-margin')}</span>
                            <span className="font-semibold">{product.profitMargin}%</span>
                          </div>
                          <div className="flex flex-col items-center justify-center gap-1">
                            <span className="text-sm text-muted-foreground">{tFields('product-minimum-profit')}</span>
