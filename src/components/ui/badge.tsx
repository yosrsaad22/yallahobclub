  ...
  'inline-flex items-center justify-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        foreground: 'border-transparent bg-foreground text-background hover:bg-foreground/80',
        background: 'border-border bg-background text-foreground hover:bg-muted',
      },
    },
    defaultVariants: {
      variant: 'default',
