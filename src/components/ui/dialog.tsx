...
const Dialog: React.FC<DialogProps> = ({
  ...
  return (
    <DialogRoot open={isOpen} onOpenChange={onChange}>
      ...
      className={cn('custom-scrollbar bg-background overflow-y-auto', classname)}>
        <DialogHeader>
