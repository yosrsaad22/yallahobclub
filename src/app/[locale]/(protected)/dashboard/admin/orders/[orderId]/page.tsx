...
import { cancelOrder, getOrderById, printLabel } from '@/actions/orders';
...
export default async function OrderDetails({ params }: OrderDetailsProps) {
  ...
  const breadcrumbItems = [
    { title: t('pages.orders'), link: '/dashboard/admin/orders' },
  ...
  return (
    <div className="w-full">
      <div className="w-full space-y-4 p-4 pt-6 md:p-6">
        ...
        <OrderDetailsCard onCancel={handleCancel} onPrintLabel={handlePrintLabel} order={orderData} />
      </div>
    </div>
  );
}
