  ...
  return (
    <div className=" mt-24 h-full  w-full">
      <div className="flex w-full flex-col items-center justify-center px-8 text-center md:pb-0">
        ...
        <p className="mb-0 mt-14 max-w-2xl translate-y-[-1rem] animate-fade-in text-center text-lg font-medium text-foreground/80 opacity-0 [--animation-delay:400ms]  md:mb-8 md:text-center">
          {t('text')}
        </p>
      </div>
